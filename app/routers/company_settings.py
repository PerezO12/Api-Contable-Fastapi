...
async def update_company_settings(
    ...
    try:
        ...
        logger.info("=== ENDPOINT: Recibiendo datos para actualización ===")
        logger.info(f"Datos recibidos del frontend: {settings_data.model_dump()}")
        logger.info("====================================================")
        
        service = CompanySettingsService(db)
        settings = await service.update_company_settings(settings_data, current_user.id)
        
        logger.info("=== ENDPOINT: Datos después de actualización ===")
        logger.info(f"Configuración actualizada: {settings.model_dump()}")
        logger.info("================================================")
